...
namespace LibGGPK
{
	...
	public sealed class FileRecord : BaseRecord, IComparable
	{
		...
		private void MarkAsFree(Stream ggpkFileStream, LinkedList<FreeRecord> freeRecordRoot)
		{
		...
		public int CompareTo(object obj)
		{
			...
			return string.Compare(Name, ((FileRecord) obj).Name, StringComparison.Ordinal);
		}
	}
}
